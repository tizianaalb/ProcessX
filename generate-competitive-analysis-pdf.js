...
async function generatePDF() {
  try {
    ...
    const markdown = fs.readFileSync('./COMPETITIVE_ANALYSIS_AND_AI_STRATEGY.md', 'utf8');
...
<body>
  ${html}
    ...
    await page.pdf({
      path: './COMPETITIVE_ANALYSIS_AND_AI_STRATEGY.pdf',
      format: 'A4',
      margin: {
        top: '20mm',
        right: '20mm',
    ...
    console.log('✅ PDF generated successfully: COMPETITIVE_ANALYSIS_AND_AI_STRATEGY.pdf');
  } catch (error) {
